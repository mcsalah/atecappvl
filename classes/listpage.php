...
{	
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\""."انتقل إلى بيانات الجدول"."\" class=\"".$this->makeClassName("s508")."\">"."انتقل إلى بيانات الجدول"."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."انتقل إلى القائمة"."\" class=\"".$this->makeClassName("s508")."\">"."انتقل إلى القائمة"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."انتقل إلى البحث"."\" class=\"".$this->makeClassName("s508")."\">"."انتقل إلى البحث"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."مفاتيح الاختصار المرجعية"."\" class=\"".$this->makeClassName("s508")."\">"."مفاتيح الاختصار المرجعية"."</a>";
		}
...
//	normal mode row count
	...
	{ 
		...
		return $fName." ". ($desc ? "الاعلى الى الادنى" : "من أسفل إلى أعلى");
	}
