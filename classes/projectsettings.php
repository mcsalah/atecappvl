...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("Ecoute_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Victime" ] = array( "url" => "victime", "type" => 0 );
	$projectEntitiesReverse[ "victime" ] = "Victime";
	$projectEntities[ "Enfants" ] = array( "url" => "enfants", "type" => 0 );
	$projectEntitiesReverse[ "enfants" ] = "Enfants";
	$projectEntities[ "Respviolence" ] = array( "url" => "respviolence", "type" => 0 );
	$projectEntitiesReverse[ "respviolence" ] = "Respviolence";
	$projectEntities[ "tviolence" ] = array( "url" => "tviolence", "type" => 0 );
	$projectEntitiesReverse[ "tviolence" ] = "tviolence";
	$projectEntities[ "tconsequences" ] = array( "url" => "tconsequences", "type" => 0 );
	$projectEntitiesReverse[ "tconsequences" ] = "tconsequences";
	$projectEntities[ "t_dossier" ] = array( "url" => "t_dossier", "type" => 0 );
	$projectEntitiesReverse[ "t_dossier" ] = "t_dossier";
	$projectEntities[ "Ecoute_users" ] = array( "url" => "ecoute_users", "type" => 0 );
	$projectEntitiesReverse[ "ecoute_users" ] = "Ecoute_users";
}
