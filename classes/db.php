...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "associaecoute2_at_20_120_102_0" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "appviol2022_audit", "varname" => "associaecoute2_at_20_120_102_0__appviol2022_audit", "altvarname" => "appviol2022_audit", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "Ecoute_users", "varname" => "associaecoute2_at_20_120_102_0__Ecoute_users", "altvarname" => "Ecoute_users", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "Enfants", "varname" => "associaecoute2_at_20_120_102_0__Enfants", "altvarname" => "Enfants", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "Respviolence", "varname" => "associaecoute2_at_20_120_102_0__Respviolence", "altvarname" => "Respviolence", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "t_dossier", "varname" => "associaecoute2_at_20_120_102_0__t_dossier", "altvarname" => "t_dossier", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "tconsequences", "varname" => "associaecoute2_at_20_120_102_0__tconsequences", "altvarname" => "tconsequences", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "tviolence", "varname" => "associaecoute2_at_20_120_102_0__tviolence", "altvarname" => "tviolence", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
			$dalTables[$conn->connId][] = array("name" => "Victime", "varname" => "associaecoute2_at_20_120_102_0__Victime", "altvarname" => "Victime", "connId" => "associaecoute2_at_20_120_102_0", "schema" => "", "connName" => "appliAtecviol at 20.120.102.0");
		}
	}
