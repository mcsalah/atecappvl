...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("Victime" == $this->chrt_array['tables'][0])
			return true;
		if("Enfants" == $this->chrt_array['tables'][0])
			return true;
		if("Respviolence" == $this->chrt_array['tables'][0])
			return true;
		if("tviolence" == $this->chrt_array['tables'][0])
			return true;
		if("tconsequences" == $this->chrt_array['tables'][0])
			return true;
		if("t_dossier" == $this->chrt_array['tables'][0])
			return true;
		if("Ecoute_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
