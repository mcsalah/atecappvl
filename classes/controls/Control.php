...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[CONTAINS] = "يحتوي";
		$this->searchOptions[EQUALS] = "يساوي";
		$this->searchOptions[STARTS_WITH] = "يبدأ بـ ...";
		$this->searchOptions[MORE_THAN] = "أكثر من ...";
		$this->searchOptions[LESS_THAN] = "أقل من ...";
		$this->searchOptions[BETWEEN] = "بين";
		$this->searchOptions[EMPTY_SEARCH] = "تفريغ";
		$this->searchOptions[NOT_CONTAINS] = "لا يحتوي على";
		$this->searchOptions[NOT_EQUALS] = "لا يساوي";
		$this->searchOptions[NOT_STARTS_WITH] = "لا يبدأ مع";
		$this->searchOptions[NOT_MORE_THAN] = "ليس أكثر من";
		$this->searchOptions[NOT_LESS_THAN] = "ليس أقل من";
		$this->searchOptions[NOT_BETWEEN] = "ليس بين";
		$this->searchOptions[NOT_EMPTY] = "ليس فارغا";
