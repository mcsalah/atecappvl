...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;localhost;root;Pl@tin123;;appliAtecviol;http://20.120.102.0/vnum/phprunner.php;0"; //currently unused

		$this->_connectionsIdByName["appliAtecviol at 20.120.102.0"] = "associaecoute2_at_20_120_102_0";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "Pl@tin123";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][2] = "Pl@tin123";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "appliAtecviol";
		$data["connInfo"][5] = "http://20.120.102.0/vnum/phprunner.php"; //currently unused
		$data["connInfo"][6] = "0"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=Pl@tin123;Database=appliAtecviol;OPTION=3";
		// encription set
