...
class ConnectionManager
{
        ...
        {
                return $this->byId( "associaecoute2_at_20_120_102_0" );
        }
        ...
        protected function _setConnectionsData()
        {
                ...
                $data = array();
                $data["dbType"] = 0;
                $data["connId"] = "associaecoute2_at_20_120_102_0";
                $data["connName"] = "appliAtecviol at 20.120.102.0";
                $data["connStringType"] = "mysql";
                $data["connectionString"] = "mysql;localhost;root;Pl@tin123;;appliAtecviol;http://localhost/atecappvl/phprunner.php;0"; //currently unused

                $this->_connectionsIdByName["appliAtecviol at 20.120.102.0"] = "associaecoute2_at_20_120_102_0";

                $data["connInfo"] = array();
                $data["ODBCUID"] = "k8s";
                $data["ODBCPWD"] = "Wafa2020";
                $data["leftWrap"] = "`";
                $data["rightWrap"] = "`";
                ...
                $data["connInfo"][0] = "20.120.102.0";
                $data["connInfo"][1] = "k8s";
                $data["connInfo"][2] = "Wafa2020";
                $data["connInfo"][3] = "";
                $data["connInfo"][4] = "appliAtecviol";
                $data["connInfo"][5] = "http://localhost/atecappvl/phprunner.php"; //currently unused
                $data["connInfo"][6] = "0"; //currently unused
                $data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=20.120.102.0;Uid=k8s;Pwd=Wafa2020;Database=appliAtecviol;OPTION=3";
                // encription set
                ...
                $connectionsData["associaecoute2_at_20_120_102_0"] = $data;
        ...
        {
                $connectionsIds = array();
                $connectionsIds["Victime"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["Enfants"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["Respviolence"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["tviolence"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["tconsequences"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["t_dossier"] = "associaecoute2_at_20_120_102_0";
                $connectionsIds["Ecoute_users"] = "associaecoute2_at_20_120_102_0";
